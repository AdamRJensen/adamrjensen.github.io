...
html_sidebars = {
    ...
    "blog": ['archives.html'],  # 'tagcloud.html'
...
nb_execution_excludepatterns = ['irradiance_maps.ipynb', 'inset_map_cartopy.ipynb', 'twoaxistracking_animation.ipynb', 'blue_marble_map.ipynb', 'earth_as_rubiks_cube.ipynb', 'draft/*']
